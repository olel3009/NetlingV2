def test_quadtree_subdivision():
    ...
    obj2 = Object(25, 25, 0, 0, 0)
    qt.insert(obj2)

    obj3 = Object(25, 75, 0, 0, 0)
    qt.insert(obj3)

    obj4 = Object(75, 25, 0, 0, 0)
    qt.insert(obj4)

    obj5 = Object(75, 75, 0, 0,0)
    qt.insert(obj5)
...
def test_quadtree_insert_and_query():
    ...
    qt.insert(obj)
    from Quadtree import range
    range1 = range(0, 0, 100, 100)
...
def test_quadtree_query_specific_range():
    from Quadtree import Quadtree, range
    from Object import Object
    qt = Quadtree(100, 100, 0, 0, 4)
    ...
    obj5 = Object(75, 75, 0, 0, 0)
    qt.insert(obj5)
    obj6 = Object(50, 50, 0, 0, 0)
    qt.insert(obj6)

    assert qt.isSubdivided() == True
    range2 = range(50, 50, 50, 50)
