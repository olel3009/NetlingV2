...
class TestIDManager(unittest.TestCase):
    ...
    def test_generateID(self):
        ...
        logging.info("ID generation test passed.")
    ...
    def test_resetID(self):
        ...
        logging.info("ID reset test passed.")
    ...
    def test_generateMultipleIDs(self):
        ...
        logging.info("Multiple ID generation test passed.")
    ...
    def test_largeIDGeneration(self):
        ...
        logging.info("Large ID generation test passed.")